...
let songs=[
    { songName:"Classroom", duration:"5:21",path:"./Prithibi_Band/Classroom.mp3"},
    { songName:"Janmodin", duration:"5:21",path:"./Prithibi_Band/Janmodin.mp3"},
    { songName:"Mon Amar", duration:"5:21",path:"./Prithibi_Band/Mon Amar.mp3"},
    { songName:"Neel Pakhi", duration:"5:21",path:"./Prithibi_Band/Neel Pakhi.mp3"},
    { songName:"Nosto", duration:"5:21",path:"./Prithibi_Band/Nosto.mp3"},
    { songName:"O Amar", duration:"5:21",path:"./Prithibi_Band/O Amar.mp3"},
    { songName:"Opekkha", duration:"5:21",path:"./Prithibi_Band/Opekkha.mp3"},
    { songName:"Shomoy", duration:"5:21",path:"./Prithibi_Band/Shomoy.mp3"},
]
