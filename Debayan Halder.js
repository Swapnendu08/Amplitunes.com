let index=0;
let audioElement= new Audio("./Debayan Halder/Emon Jodi Hoto.mp3");
...
// audioElement.play();
let songs=[
    { songName:"Emon Jodi Hoto", duration:"5:21",path:"./Debayan Halder/Emon Jodi Hoto.mp3"},
    { songName:"Monta re", duration:"5:21",path:"./Debayan Halder/Monta re.mp3"},
    { songName:"Neshar Bojha", duration:"5:21",path:"./Debayan Halder/Neshar Bojha.mp3"},
    { songName:"She Je Bose ache", duration:"5:21",path:"./Debayan Halder/She Je Bose ache.mp3"},
    { songName:"মন - কযকটস", duration:"5:21",path:"./Debayan Halder/মন - কযকটস.mp3"},
]
