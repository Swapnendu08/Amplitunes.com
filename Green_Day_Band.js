let index=0;
let audioElement= new Audio("./Green_Day_Band/21_guns.mp3");
...
// audioElement.play();
let songs=[
    { songName:"21_guns", duration:"5:21",path:"./Green_Day_Band/21_guns.mp3"},
    { songName:"Boulevard of Broken Dreams", duration:"5:21",path:"./Green_Day_Band/Boulevard of Broken Dreams.mp3"},
    { songName:"Holiday", duration:"5:21",path:"./Green_Day_Band/Holiday.mp3"},
    { songName:"Still Breathing", duration:"5:21",path:"./Green_Day_Band/Still Breathing.mp3"},
    { songName:"Waiting", duration:"5:21",path:"./Green_Day_Band/Waiting.mp3"},
    { songName:"Wake Me up When September Ends", duration:"5:21",path:"./Green_Day_Band/Wake Me up When September Ends.mp3"},
]
