let index=0;
let audioElement= new Audio("./The_Local_Train/Aaftaab.mp3");
...
// audioElement.play();
let songs=[
    { songName:"Aaftaab", duration:"5:21",path:"./The_Local_Train/Aaftaab.mp3"},
    { songName:"Aaoge Tum Kabhi", duration:"5:21",path:"./The_Local_Train/Aaoge Tum Kabhi.mp3"},
    { songName:"Choo Lo", duration:"5:21",path:"./The_Local_Train/Choo Lo.mp3"},
    { songName:"Dil Mere", duration:"5:21",path:"./The_Local_Train/Dil Mere.mp3"},
    { songName:"Kaisey Jiyun", duration:"5:21",path:"./The_Local_Train/Kaisey Jiyun.mp3"},
    { songName:"Khudi", duration:"5:21",path:"./The_Local_TrainKhudi.mp3"},
    { songName:"Manzil", duration:"5:21",path:"./The_Local_Train/Manzil.mp3"},
    { songName:"Mere Yaar", duration:"5:21",path:"./The_Local_Train/Mere Yaar.mp3"},
    { songName:"Vaaqif", duration:"5:21",path:"./The_Local_Train/Vaaqif.mp3"},
    { songName:"Yeh Zindagi Hai", duration:"5:21",path:"./The_Local_Train/Yeh Zindagi Hai.mp3"},
]
