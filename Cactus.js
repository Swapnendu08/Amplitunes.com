let index=0;
let audioElement= new Audio("./Prithibi_Band/Classroom.mp3");
...
// audioElement.play();
let songs=[
    { songName:"Amra Harina", duration:"5:21",path:"./Cactus/Amra Harina.mp3"},
    { songName:"Bandhu Re", duration:"5:21",path:"./Cactus/Bandhu Re.mp3"},
    { songName:"Bhalo Theko", duration:"5:21",path:"./Cactus/Bhalo Theko.mp3"},
    { songName:"Kristi", duration:"5:21",path:"./Cactus/Kristi.mp3"},
    { songName:"Mon", duration:"5:21",path:"./Cactus/Mon.mp3"},
    { songName:"Nil Nirjone", duration:"5:21",path:"./Cactus/Nil Nirjone.mp3"},
    { songName:"Noah", duration:"5:21",path:"./Cactus/Noah.mp3"},
    { songName:"Shudhu Tumi Ele Na", duration:"5:21",path:"./Cactus/Shudhu Tumi Ele Na.mp3"},
    { songName:"Tobuo Thik Achhe", duration:"5:21",path:"./Cactus/Tobuo Thik Achhe.mp3"},
    { songName:"Udener Gaan", duration:"5:21",path:"./Cactus/Udener Gaan.mp3"},
]
